...
X=zeros()
img = imread('face.jpg');
img=im2double(reshape(img,218,534))
X=img
...
k = 0;
threshold=0.99
while percent < threshold  % change this percent for different levels of variance capture
    k = k+1;
...
k = 0;
for PCNum = 1:1:10 %% change number of principle components here
    Error = 0;
